<template>
    <button title="Notifications" class="nav-dropdown-toggle br-50 relative" :id="id" @click="openDropdown(id)">
        ...
        <i v-if="notification_count > 0" class="bg-danger br-24 fs-08">{{ notification_count }}</i>
    </button>
    <teleport to="body">
