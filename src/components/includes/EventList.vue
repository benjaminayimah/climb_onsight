                ...
                <div class="flx jc-sb ai-fe gap-8">
                    <div class="flx gap-8">
                        <div class="flx column">
                            <div v-if="event.event_type === 'public'" class="label flx gap-4 ai-c">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="26" viewBox="0 0 24 26">
                            ...
                            <div v-else class="label flx gap-4 ai-c">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="21.137" viewBox="0 0 21.137 21.137">
                            ...
                            <span class="wrap-text wrap-line-1" title="Jun 20">{{ event.event_type === 'public' ? format_date_short3(event.start_date) : event.event_duration }}</span>
                        </div>
                        <div class="flx column">
                            <div class="label flx gap-4 ai-c">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" viewBox="0 0 20.101 19.821">
        ...
        doClick() {
            if(this.redirect) {
                ...
                if (this.$route.name === route_name && this.$route.query.type !== 'all') {
                    this.$router.push({ name: route_name, query: { type: this.eventType, current: this.event.id, origin: this.$route.name } } )
                }else {
                    this.$router.push({ name: route_name, query: { type: 'all', current: this.event.id, origin: this.$route.name } } )
                }
            }else {
