<template>
    <li>
        <a href="" class="flx jc-sb ai-c gap-8">
            <div class="flx gap-8">
                ...
                <div class="wrap-text wrap-line-2 flx noti-preview">Ivan Jhay accepted your guide request</div>
            </div>
            <span class="pill fs-09">View</span>
        </a>
    </li>
</template>
