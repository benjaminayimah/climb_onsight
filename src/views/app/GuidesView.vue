<template>
    <section class="flx gap-24 column main guide-section">
        <div v-if="guides.length" class="flx section-main-wrapper">
            ...
            <transition name="slide-from-right">
                <div v-if="$route.query.id" class="flx-grow-1 section-main-right">
                    ...
                    <div class="body-content pd-l-24 bd-l-1 overflow-y-scroll">
                        <guide-details :guide="computedUser" />
                    </div>
                </div>
            </transition>
        </div>
        <div v-else class="empty-state flx column jc-c ai-c gap-16">
            <div class="text-center">
                ...
                <h3>No Guide</h3>
                <div class="mb-24">There are no registered guide</div>
            </div>
        </div>
    </section>
</template>
...
export default {
    components: { UserList, GuideDetails, SearchButton },
    name: 'GuidesView',
    computed: {
        ...mapState({
