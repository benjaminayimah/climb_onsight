  ...
  <teleport to="#modal_title">
    ...
    <teleport to="#modal_content">
        <div class="modal-width">
            <form @submit.prevent="" class="flx column gap-24" id="reset_admin_pass_form">
    ...
    <teleport to="#modal_footer">
        <button @click="submitUpdate" class="button-primary w-100 gap-8 btn-lg" :class="{ 'button-disabled' : submiting }" :disabled="submiting ? true : false">
