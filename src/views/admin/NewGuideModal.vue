            ...
            <div class="br-16 flx column gap-24">
                <div class="flx column gap-16">
                    ...
                    <div class="flx gap-24 flx-1 flx-wrap">
                        ...
                        <div v-if="computedLicense.length">
                            <div class="gray fs-09">Permit or License</div>
                            <div>
                        ...
                        <div v-if="guide.customer_reviews">
...
export default {
    ...
    computed: {
        ...
        computedLicense() {
            if(this.guide.guide_license && Array.isArray(JSON.parse(this.guide.guide_license))) {
                return JSON.parse(this.guide.guide_license)
            }
            else
            return []
        },
